 ...
 * @author Mariz
 */
public class AD_ACT_LOG extends javax.swing.JInternalFrame {

    /** Creates new form AD_ACT_LOG */
    public AD_ACT_LOG() {
        initComponents();
        updateTableData();
...
public void updateTableData() {
            ...
            String sql = "SELECT * FROM activity_history ORDER BY ACT_ID DESC";
            ...
            try {
                ...
                while (rs.next()) {
                    String column1Value = rs.getString("ACT_ID");
                    String column2Value = rs.getString("PHAR_ID");
                    String column3Value = rs.getString("PHAR_USERNAME");
                    String column4Value = rs.getString("PHAR_NAME");
                    String column5Value = rs.getString("PHAR_POS");
                    String column6Value = rs.getString("ACT_DATE");
                    String column7Value = rs.getString("ACT_TIME");
                    String column8Value = rs.getString("ACT_ACTION");
                    model.addRow(new Object[]{column1Value, column2Value, column3Value, column4Value, column5Value, column6Value, column7Value, column8Value });
                }
    ...
    header1.setDefaultRenderer(new AD_ACT_LOG.CustomHeaderRenderer());
    String[] headerTitles1 = {"Actiivty ID", "USER ID", "Username", "Name", "Position", "Date", "Time", "Action"};
...
//    jTable2.setAutoResizeMode(JTable.AUTO_RESIZE_ALL_COLUMNS);
    ...
    private void initComponents() {
        ...
        setOpaque(true);
        setPreferredSize(new java.awt.Dimension(1188, 711));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Activity ID", "User ID", "Username", "Name", "Position", "Date", "Time", "Action"
            }
        ));
 ...
 Timer timer = new Timer(10000 , e -> updateTableData());
        if(search.getText().isEmpty()){
            ...
            String sql = "SELECT * FROM `activity_history` where PHAR_NAME LIKE ?";
            ...
            stm.setString(1, searchTerm);   
                ...
                if (!itemExists) {
                    JOptionPane.showMessageDialog(null, "Activity ID not found.");
                }
